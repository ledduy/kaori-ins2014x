function rerank_using_DPM_and_RANSAC_2014_RUN3_super_stars(start_video_id, end_video_id)
% Example:
...
base_BOW_fusion = 'R1_tv2013.fusion-surrey.hard.soft+CZBest+DPM.surrey.hard.soft[1-1-1]';
...
if is_using_RANSAC
	RESULT_RUN_ID = ['R0_', data_name, '.', base_feature, '+DPM+RANSAC+CZBest'];
end
