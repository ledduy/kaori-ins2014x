...
function rerank_using_RANSAC_fgbg_tf_avg(data_name, base_feature, base_RANSAC, start_video_id, end_video_id)
% Example:
...
RESULT_RUN_ID = ['R0_', data_name, '.', base_feature, '+RANSAC_tf_avg'];
