function rerank_using_DPM_and_RANSAC_2014_RUN2_soft_soft(start_video_id, end_video_id)
% Example:
...
data_name = 'tv2014';
base_feature = 'surrey.soft.soft';
base_BOW_fusion = 'R1_tv2013.fusion-surrey.soft.soft+perdoch.soft.soft+DPM.surrey.soft.soft[2-1-1]';
base_RANSAC = 'R4_tv2013.rawRANSAC.surrey.soft.soft.latefusion.asym';
base_DPM = 'R3_tv2013.DPM.surrey.soft.soft.latefusion.asym_fg+bg_0.1_hesaff_rootsift_noangle_akmeans_1000000_100000000_50_kdtree_8_800_v1_f1_3_0.0125_avg_pooling_full_notrim_clip_idf_nonorm_kdtree_3_0.0125_-1_dist_avg_autoasym_ivf_0.5';
%	start_video_id = 1
%	end_video_id = 1000
